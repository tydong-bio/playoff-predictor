  ...
  return (
    <div className="page">
      <style>{`
        ...
        .finalsHero{margin:0 0 16px;padding:20px 18px;border-radius:24px;background:
          radial-gradient(circle at 20% 20%, rgba(255,255,255,.18), transparent 25%),
          radial-gradient(circle at 80% 20%, rgba(245,158,11,.18), transparent 25%),
          linear-gradient(135deg,#0b0b0f 0%, #1f2937 45%, #111827 100%);
          color:#fff;border:1px solid rgba(245,158,11,.32); box-shadow:0 18px 48px rgba(0,0,0,.22);}
        ...
        @media (max-width:700px){
          .finalsHero{padding:16px 14px}
          .finalsHeroMain{grid-template-columns:1fr;gap:10px}
          .finalsHeroVs{text-align:center;font-size:22px}
          .finalsHeroName{font-size:24px}
        }
      `}</style>
